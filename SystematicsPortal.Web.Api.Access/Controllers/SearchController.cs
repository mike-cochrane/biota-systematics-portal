...
using SystematicsPortal.Web.Api.Access.Infrastructure;
using SystematicsPortal.Web.Api.Access.Services;
using SystematicsPortal.Web.Search.Tools.Models;
using SystematicsPortal.Web.Search.Tools.Models.Search;

namespace SystematicsPortal.Web.Api.Access.Controllers
{
    [ApiController]
    [Route("[controller]")]
