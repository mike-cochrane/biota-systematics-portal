...
INSERT INTO @FieldGroup(FieldGroupId, DocumentClass, DisplayTitle, [Name], DisplayOrder, DisplayFormat)
VALUES
	-- name groups
	...
	, ('6CD69A89-0AFB-4C0A-96A0-79E064A8AD66', 'name'		, 'Current Biostatus'		, 'Active Biostatus'	, 30, NULL)	
	...
	, ('D636F428-5DD3-4DF1-9306-2EBF7E8D59F9', 'name'		, 'Synonyms'				, 'Synonymy'			, 60, NULL)
	, ('842838C6-B3F4-4106-8323-0A806F81F080', 'name'		, 'Siblings'				, 'Siblings'			, 70, NULL)
	, ('824E901A-0685-4F63-B275-36C4DE97FABD', 'name'		, 'Subordinates'			, 'Children'			, 80, NULL)
	, ('B45FAF01-FCB9-40CF-9EFA-DD6B57ACF6E4', 'name'		, 'Classification'			, 'Classification'		, 90, NULL)
	, ('A4CCD8EE-D5AB-4106-9E0F-5D030B6EE9CE', 'name'		, 'Vernacular Names'		, 'Vernacular Names'	, 100, NULL)
	, ('9ED00B87-7D3B-4476-AE5E-0E284B6BB276', 'name'		, 'Hybridisation'			, 'Hybridisation'		, 110, NULL)
	, ('C7367F22-38D9-4A34-BB1E-F0063D1FDC70', 'name'		, 'Taxonomic Concepts'		, 'Concepts'			, 120, NULL)
	, ('DAFF9AB3-4AAD-44D4-89A6-8F090BD13AB0', 'name'		, 'External Name Resources'	, 'External Names'		, 130, NULL)
	, ('5DE88990-6648-4AE8-8717-B52088B05DDF', 'name'		, 'Related resources'		, 'Hyperlinks'			, 140, NULL)
	, ('32537FC4-BBEA-4DF1-8A92-D567901D24CA', 'name'		, 'Collection Objects'		, 'Collection Data'		, 150, NULL)
	, ('2542FEF5-7339-446A-B85D-26119AD8016A', 'name'		, 'Notes'					, 'Notes'				, 160, NULL)
	, ('BF0D359C-95E6-41DF-9847-B9AC8316EC37', 'name'		, 'Identification Keys'		, 'InKeys'				, 170, NULL)
	, ('4899BD5F-FFE2-4512-9E4B-02077BE0075F', 'name'		, 'Historic Biostatus'		, 'Inactive Biostatus'	, 180, NULL)
	, ('88953ACB-15CC-4D1F-A15C-54B81C5A107E', 'name'		, 'Record Metadata'			, 'Metadata'			, 190, NULL)
	-- reference groups
...
WHEN NOT MATCHED BY TARGET 
	THEN 
		INSERT (FieldGroupId, DocumentClass, DisplayTitle, [Name], DisplayOrder, DisplayFormat)
		VALUES (FieldGroupId, DocumentClass, DisplayTitle, [Name], DisplayOrder, DisplayFormat)
WHEN MATCHED 
       THEN 
		UPDATE 
			SET 
				...
				, DisplayFormat		= iFG.DisplayFormat
